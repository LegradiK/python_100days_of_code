...
#Win: user_total < 22, computer_total > 21, user_total > computer_total
#Lose: user_total > 21, computer_total < 22, computer_total > user_total     
#Draw: user_total > 21 and computer_total > 21, user_total = computer_total
    ...
    if  user_total < 22 and computer_total > 21:
      ...
      print(f"Computer cards: {computer}, Computer's score: {computer_total}")
      play_again = False
#Check a video to see if computer needs to choose either 1 or 11 for A card
